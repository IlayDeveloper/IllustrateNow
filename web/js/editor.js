(function(){
    ...
    var tag_title = ' <span class="post-title">Пример пример </span>';
    ...
    var tag_table = '<div class="post-table"> <div class="row"> <div class="col-md-7"> <div class="row post-table-title"></div> </div> <div class="col-md-1"></div> <div class="col-md-4"> <div class="row post-table-title"></div> </div> </div> <div class="row"> <div class="col-md-7"> <div class="row post-table-usual">Пример строки</div> </div> <div class="col-md-1"></div> <div class="col-md-4"> <div class="row post-table-usual">Пример строки</div> </div> </div> </div>';
    /* * * * */
